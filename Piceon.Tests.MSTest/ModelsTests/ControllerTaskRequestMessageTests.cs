...
namespace Piceon.Tests.MSTest.ModelsTests
{
    ...
    public class ControllerTaskRequestMessageTests
    {
        ...
        public void ToJsonTest()
        {
            ...
            msg.images.Add(new List<string>() { "1", "image/1" });
            msg.images.Add(new List<string>() { "2", "image/2" });
        ...
        public void FromJsonTest()
        {
            ...
            expected.images.Add(new List<string>() { "1", "image/1" });
            expected.images.Add(new List<string>() { "2", "image/2" });
